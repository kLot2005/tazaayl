...
let TelegramService = class TelegramService {
    ...
    constructor(bot, subscriberRepository) {
        this.bot = bot;
        this.subscriberRepository = subscriberRepository;
    }
    async notifyZoneSubscribers(zoneId, message) {
...
exports.TelegramService = TelegramService = __decorate([
    ...
    __param(1, (0, typeorm_1.InjectRepository)(subscriber_entity_1.TelegramSubscriber)),
